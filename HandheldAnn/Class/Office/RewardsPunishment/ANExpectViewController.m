...
#import "ANExpectViewController.h"

@interface ANExpectViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation ANExpectViewController
...
- (void)loadData{
    ...
    paraDic = @{@"action":@"getDRList",@"Type":@"8",@"SiteName":@"重庆观音桥", @"Level":level,@"Man":man};
